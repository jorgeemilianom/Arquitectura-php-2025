...
abstract class Wallet implements IWallet, IErrorsValidator {
    public $endpoint;

    public function setDataPoint()
    {
        // Implementación de la funcionalidad para establecer el punto de datos
    }
...
class MercadoPago extends Modo
{
    ...
    public function __construct() {
        try {
            ...
            # Conecto con una api externa

        } catch (\Throwable $th) {
            
            // La exception de Modo, entra aca
        }
...
if($mp instanceof IErrorsValidator) {
    // entra
}

class Modo extends Wallet implements IPayment
{

    public function __construct() {
        throw new RuntimeException("Error Processing Request", 3);
        ...
        try {
            ...
            if (2) {
                # code...
                throw new LogicException("Error Processing Request", 2);
            }
...
class Stripe extends Wallet implements IPayment
{
    public function executePayment()
    {
        // Implementación de la funcionalidad de pago con MercadoPago
...
class Payway extends Wallet implements IPayment
{
    public function executePayment()
    {
        // Implementación de la funcionalidad de pago con MercadoPago
...
class Paypal extends Wallet implements IPayment 
{
    public function executePayment()
    {
